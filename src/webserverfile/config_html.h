  ...
  <hr>
    ...
    <input id="OnSecond" type="time" name="OnSecond" value="00:00" onchange="sheduleSend()" /></br>  <!-- https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/time -->
      ...
      <label class="toggle" Title="Turn On/Off"> <!-- https://alvarotrigo.com/blog/toggle-switch-css/ -->
        ...
        <label class="button-checkbox" title="Set to manual; enforce schedule until this is disabled/gray."> <!-- https://stackoverflow.com/questions/38377062/how-to-make-html-button-look-pressed-in-using-css -->
    ...
    <div id="MQTT" class="tabcontent">
      ...
      <span style="display: inline-block; width: 5em;"><label for="mqttLocation" Title="Defines the facility the device is located at">Location: </label></span> <input type="text" id="mqttLocation" onchange="mqttSend()"></br>
      </div>
    </div>
</body>
</html>
